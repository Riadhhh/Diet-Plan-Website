// Initialize Swiper
var dietSwiper = new Swiper(".dietSwiper", {
  slidesPerView: 1,
  spaceBetween: 30,
  loop: true,
  pagination: {
...
// untuk menghitung BMI dan menampilkan hasil
function calculate() {
...
function countBmi() {
    ...
    // kategori BMI dan memberikan saran
    if (bmi < 18.5) {
        result = 'Underweight';
    ...
    // pindah ke halaman result dengan parameter URL
    window.location.href = "src/result.html?" + urlParams.toString();
}
...
if (window.location.pathname.includes('src/result.html')) {
